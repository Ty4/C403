 ...
 * It uses a greedy algorithm the store only the fact that people gave and
 *   received money. The final output is decided by simple going through the
 *   transactions and finding who gave money and who received money, subtracting
 *   totals given/received as it goes.
*/
