 ...
 *
 * This is a very simple problem. The actual sorting is handled by std::set.
 * Set sorts the struct Job based first on the ratio of time needed to
 * complete the job to fine per day missed.
*/
...
typedef struct Job
{
	...
	// this operator overload holds the real key to the problem.
